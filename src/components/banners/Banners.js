...
function DashboardFilterBanner() {
  ...
  const onChange = (date, dateString) => {
    setstateDate({ ...state, date, dateString });
  };
  return (
    <DashboardCtaFilterWrap>
      <div className='ant-card'>
        <div className='ant-card-head'>
        <div className='ant-card-head-title'>Sales Last Update: 09/10/2023</div>
        </div>
        ...
        <div className="ninjadash-card-nav">
          <span>search By: </span>
            ...
            <Radio.Group defaultValue={1}>
                  <Radio onClick={() => handleTabActivation('period')} value={1}>Period</Radio>
                  <Radio onClick={() => handleTabActivation('range')} value={2}>Range</Radio>
